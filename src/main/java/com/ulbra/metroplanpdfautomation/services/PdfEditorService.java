...
public class PdfEditorService {
    ...
    public void generatePresencialityDeclaration(final HttpServletResponse response, final StudentInformation studentInformation, final MultipartFile multipartFile) {
    ...
    @Async
    public void saveGeneratedPdf(final PDDocument pdDocument, final StudentInformation studentInformation) {
        try {
    ...
    // the error
    private void writeText(final PDPageContentStream contentStream, float pageWidth, final String textToWrite, final Integer fontSize, final Integer margin, final AtomicReference<Integer> lineIndexList) throws IOException {
